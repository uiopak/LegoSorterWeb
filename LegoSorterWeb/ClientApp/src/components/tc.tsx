...
export default function Tc() {
    ...
    return (
        <div class="flex gap-2">
            <button data-set-theme="light" class="btn btn-ghost hidden sm:flex btn-square" data-act-class="btn-active">
            ...
            <button data-set-theme="dark" class="btn btn-ghost hidden sm:flex btn-square" data-act-class="btn-active">
