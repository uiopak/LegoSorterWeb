        ...
        <>
            {/*<div class="navbar bg-base-200 gap-1">
                <div class="navbar-start">
                    ...
                    <ul class="menu menu-horizontal rounded-box hidden lg:flex-1">
                        <li>
                        ...
                        <li tabindex="0">
                            ...
                            <ul tabindex="0" class="rounded-box bg-base-200 z-50">
                                <li>
                                    <A class="normal-case text-xl" href="/control" end={true}>
                                        App Conf
                                    </A>
                                </li>
                                <li>
                                    <A class="normal-case text-xl" href="/config" end={true}>
                                        Web Conf
                                    </A>
                                </li>
                                <li>
                                    <A class="normal-case text-xl" href="/configServer" end={true}>
                                        Server Conf
                                    </A>
                                </li>
                            </ul>
